...
router.get('/assets', ensureAuthenticated, requireRole('administrator'), assetController.getAllAssets)
...
router.get('/assets/:assetId', requireRole('administrator'), assetController.getAssetInfo)
